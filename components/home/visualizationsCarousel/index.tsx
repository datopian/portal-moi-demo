    ...
    <div className="custom-container mx-auto py-10">
      <div className="flex items-start justify-between mb-6">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500">Key economic indicators for UAE trade and finance.</p>
        </div>
        <Link href="/search" className="text-sm font-semibold text-accent hover:text-accent-600 flex items-center gap-1 transition-colors shrink-0">
          View all datasets
